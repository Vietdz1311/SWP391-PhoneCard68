      ...
      <div class="p-10">
        ...
        <div class="space-y-8 text-lg">
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div>
              <p><strong>Số dư ví:</strong> <span class="text-green-600 font-bold text-2xl"><fmt:formatNumber value="${user.walletBalance}" type="number"/>₫</span></p>
              <p><strong>Vai trò:</strong> <span class="px-3 py-1 rounded-full text-sm font-medium ${user.role == 'Admin' ? 'bg-purple-100 text-purple-800' : sessionScope.user.role == 'Staff' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'}">${sessionScope.user.role}</span></p>
            </div>
          </div>
