...
public class CardProductDAO {
    ...
    private CardProduct mapProduct(ResultSet rs) throws Exception {
        ...
        cp.setFaceValue(rs.getBigDecimal("face_value"));
        cp.setSellingPrice(rs.getBigDecimal("selling_price"));
